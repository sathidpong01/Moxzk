...
test('Electron runtime installs through window bridge and keeps unsupported desktop stubs explicit', () => {
  ...
  assert.match(app, /mg-has-custom-chrome/)
  assert.match(app, /mg-app-chrome/)
  assert.match(app, /mg-command-dock/)
  ...
  assert.match(css, /mg-command-dock/)
  assert.match(css, /mg-chrome-divider/)
})
