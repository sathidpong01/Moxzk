  ...
  readonly localServices = {
    ...
    getPanelCleanerDependencyStatus: async () => ({
      ...
      python: {
        ...
        actionHint: 'Desktop app is required to check Python automatically.',
      },
    }),
    installPython: () => unsupportedRuntimeAction('Web runtime cannot install Python.'),
    installOllama: () => unsupportedRuntimeAction('Web runtime cannot install Ollama.'),
