---
title: "Getting Started with Konva — HTML5 Canvas 2D Framework | Konva - JavaScript Canvas 2d Library"
...
Get started with your framework: [React](https://konvajs.org/docs/react/index.html) · [Vue](https://konvajs.org/docs/vue/index.html) · [Svelte](https://konvajs.org/docs/svelte/index.html) · [Angular](https://konvajs.org/docs/angular/index.html)
...
- **Resize and rotate** — The built-in [`Transformer`](https://konvajs.org/docs/select_and_transform/Basic_demo.html) component adds resize and rotate handles to any shape.
...
- **High performance** — Handles thousands of shapes. See [performance tips](https://konvajs.org/docs/performance/All_Performance_Tips.html) and [stress test demos](https://konvajs.org/docs/sandbox/10000_Shapes_with_Tooltip.html).
...
- [Canvas Design Editor](https://konvajs.org/docs/sandbox/Canvas_Editor.html) — Canva-style design tool
- [Free Drawing App](https://konvajs.org/docs/sandbox/Free_Drawing.html) — Whiteboard / freehand drawing
- [Image Annotation](https://konvajs.org/docs/sandbox/Image_Labeling.html) — ML labeling tool
- [Seat Reservation Map](https://konvajs.org/docs/sandbox/Seats_Reservation.html) — Interactive seat booking
- [Interactive Building Map](https://konvajs.org/docs/sandbox/Interactive_Building_Map.html) — Floor plan visualization
- [Connected Objects](https://konvajs.org/docs/sandbox/Connected_Objects.html) — Diagram / flowchart builder

[See all 60+ demos →](https://konvajs.org/docs/sandbox.html)

## Next Steps

- [Konva Overview](https://konvajs.org/docs/overview.html) — Understand the architecture (Stage → Layer → Shape)
- [Shapes](https://konvajs.org/docs/shapes/Rect.html) — Learn about all available shapes
- [Events](https://konvajs.org/docs/events/Binding_Events.html) — Handle clicks, hovers, touches, and more
- [Drag and Drop](https://konvajs.org/docs/drag_and_drop/Drag_and_Drop.html) — Make shapes draggable
- [Animations](https://konvajs.org/docs/animations/Create_an_Animation.html) — Animate shape properties
- [About Konva](https://konvajs.org/docs/about.html) — Who uses Konva, key facts, and links